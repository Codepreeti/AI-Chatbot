const API_KEY = 'AIzaSyDc8wPEys2kDFtXm4wlF_yIfU2QCui1iBg'; 
...
function addMessage(message, isUser) {
    ...
    if (isUser) {
        ...
        profileImage.classList.add('profile-image', 'user-image');
        profileImage.src = 'user logo.png';
        profileImage.alt = 'User';
        messageElement.appendChild(profileImage);
    } else {
        const botVideo = document.createElement('video');
        botVideo.classList.add('profile-video', 'bot-video');
        botVideo.src = 'robot chat.mp4'; // Replace with the correct path to your video file.
        botVideo.alt = 'Bot';
        botVideo.width = 30; // Adjust dimensions as needed.
        botVideo.height = 30;
        botVideo.autoplay = true;
        botVideo.loop = true;
        botVideo.muted = true; // Mute the video for a better user experience.
        messageElement.appendChild(botVideo);
    }
